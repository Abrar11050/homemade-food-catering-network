        ...
        <section className="container py-5 stub-margin-92">
            ...
            <div className="row">
                ...
                <div className="col-lg-4 stub-margin-20">
                    <p>Sort order</p>
                    <div className="btn-group width100">
                        <button className={asc  ? "btn btn-dark" : "btn btn-outline-dark"} onClick={() => setAsc(true)}>Ascending</button>
                        <button className={!asc ? "btn btn-dark" : "btn btn-outline-dark"} onClick={() => setAsc(false)}>Descending</button>
                    </div>
                </div>
            </div>
        </section>
